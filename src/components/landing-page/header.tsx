  ...
  return (
    <header className="p-4 flex justify-center items-center">
      <Link href="#" className="w-full justify-left items-center flex gap-2">
        {/* <Image/> */}
        <h1>LOGO</h1>
        <span className="font-semibold dark:text-white">ProNote</span>
      </Link>
            ...
            <NavigationMenuContent>
              <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                <li className="row-span-3">
                  <span className="flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-muted/50 to-muted p-6 no-underline oultine-none focus:shadow-md">
                    Welcome
                  </span>
                </li>
            ...
            <NavigationMenuContent>
              <ul className="grid w-[400px] gap-3 p-4 md:grid-row-2">
                ...
                <ListItem title="Free Plan" href="#">
                  Great for team just starting out.
                </ListItem>
              </ul>
            </NavigationMenuContent>
          </NavigationMenuItem>
      ...
      <aside className="w-full flex gap-2 justify-end">
        <Link href={"/login"}>
    ...
    <li>
      <NavigationMenuLink asChild>
        ...
        >
          ...
          <p className="group-hover:text-white/70 line-clamp-2 text-sm leading-snung text-white/40">
            {children}
          </p>
        </a>
      </NavigationMenuLink>
