...
ALTER TABLE "folders" ALTER COLUMN "createt_at" SET DEFAULT now();--> statement-breakpoint
ALTER TABLE "folders" ALTER COLUMN "createt_at" SET NOT NULL;--> statement-breakpoint
